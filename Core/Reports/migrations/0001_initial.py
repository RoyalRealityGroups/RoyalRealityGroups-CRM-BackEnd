    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screen_name', models.CharField(blank=True, help_text='Name of the model/screen being imported', max_length=100, null=True)),
                ('file_name', models.CharField(blank=True, help_text='Original uploaded file name', max_length=255, null=True)),
                ('total_records', models.IntegerField(blank=True, default=0, help_text='Total records in file', null=True)),
                ('new_records', models.IntegerField(blank=True, default=0, help_text='New records created', null=True)),
                ('updated_records', models.IntegerField(blank=True, default=0, help_text='Existing records updated', null=True)),
                ('error_records', models.IntegerField(blank=True, default=0, help_text='Records with errors', null=True)),
                ('is_dryrun', models.BooleanField(blank=True, default=False, help_text='True if this was a validation/preview only', null=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.SmallIntegerField(choices=[(1, 'Day'), (2, 'Week'), (3, 'Month'), (4, 'Year'), (5, 'Custom')], default=1, null=True)),
                ...
                ('fileformat', models.SmallIntegerField(choices=[(0, 'CSV'), (1, 'XLS'), (2, 'XLSX'), (3, 'TSV'), (4, 'ODS'), (5, 'JSON'), (6, 'YML'), (7, 'HTML')], default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('screen', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='pdf_templates', to='contenttypes.contenttype')),
            ],
            options={
                'abstract': False,
            },
